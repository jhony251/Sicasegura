<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CorrespondenciaDETALLE.aspx.vb" Inherits="SICAH_SeguimientoAdministrativoDETALLE
" %>
                                ...
                                <tr>
                                    ...
                                    <tr><td  align="left" colspan="1" style="width: 102px"><a  id = "MostrarFiltro" href="javascript:void(0)" onclick="javascript:filtrar()">Ocultar Filtro</a></td>
                                        <td colspan="5" align="right">
                                            <%--<asp:LinkButton runat="server" ID="lbtNuevo">&nbsp;Nuevo Seguimiento</asp:LinkButton>--%>
                                        </td>
                                   </tr>
                                    <tr>                                        
