                    ...
                    <td style="padding-left:20px; padding-right:20px; width:79%; height: 621px;" valign=top>
                        ...
                        <table width="100%">
                            ...
                            <table style="height: 112px; width: 100%;">                                                                   
                                    <tr><td class="tituloSec" colspan=7>MANTENIMIENTO DE SEGUIMIENTOS ADMINISTRATIVOS</td></tr>
                                <tr>
                                    ...
                                    <tr><td  align="left" colspan="1" style="width: 102px"><a  id = "MostrarFiltro" href="javascript:void(0)" onclick="javascript:filtrar()">Ocultar Filtro</a></td>
                                        <td colspan="6" align="right"><asp:LinkButton runat="server" ID="lbtNuevo" visible="<%#visibleSegunPerfil()%>">&nbsp;Nuevo Seguimiento</asp:LinkButton></td>
                                   </tr>
                                    <tr>                                        
                                    ...
                                    <td class="encabListado" style="width: 95px">
                                        Código Cauce</td>   
                                        <td class="encabListado" style="width: 95px">
                                            Código PVYCR</td>
                                    ...
                                    <ItemTemplate>
                                        <tr <%# checkFila()%>>
                                            ...
                                            <table cellspacing="2">        
                                                ...
                                                </tr> <!--<asp:LinkButton ID="lbtBoletin" Visible='<%#VisibleSegunvalor(container.dataitem("numref")) %>' Runat="server" CommandName='boletin'  CommandArgument='<%# container.dataitem("numref")%>'  ><img src="../images/Editar.gif" border="0px" align="left" alt="Boletín Guardería" ></asp:LinkButton>-->
                	                        </table> 
                	                        </td>
                                        </tr>
                                    </ItemTemplate>
