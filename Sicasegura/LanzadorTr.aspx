<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LanzadorTr.aspx.vb" Inherits="LanzadorTr" %>
                            ...
                            <tr>
                                ...
                                <td valign="bottom" style="padding-top:25px;width:30%;">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <a href="http://192.168.41.3:8123/" target="_blank">
                                                    <img width="64" src="images/aplicaciones/email.png" alt="Seguimiento de incidencias" />
                                                </a>
                                            </td>
                                            <td>
                                                <a href="http://Intranet" target="_blank">
                                                    <img width="64" src="images/aplicaciones/home.png" />
                                                </a>
                                            </td>
                                            <td>
                                                <a href="http://192.168.194.11:85/" target="_blank">
                                                    <img width="64" src="images/aplicaciones/history.png" alt="Mantenimiento de equipos" />
                                                </a>
                                            </td>
                                            <td>
                                                <a href="http://192.168.194.11/basefotografica/menu.asp" target="_blank">
                                                    <img width="64" src="images/aplicaciones/fotos.png" alt="Acceso a galeria fotográfica"/>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
