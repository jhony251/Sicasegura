...
LightBox.prototype = {
	...
	var lightbox = new LightBox({
		loadingimg:'../js/LightBox/loading.gif',
		expandimg:'../js/LightBox/expand.gif',
		shrinkimg:'../js/LightBox/shrink.gif',
		previmg:'../js/LightBox/prev.gif',
		nextimg:'../js/LightBox/next.gif',
		effectimg:'../js/LightBox/zzoop.gif',
		effectpos:{x:-40,y:-20},
		effectclass:'../js/LightBox/effectable',
		closeimg:'../js/LightBox/close.gif',
		resizable:true
	});
});
