<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="Obras_index" %>
                ...
                <div id="container2">
                    ...
                    <asp:Literal ID="HTML_Menu_Navegacion"   runat="server"></asp:Literal>
                        <div id="content-wrapper">
                            ...
                            <div id="left-column">
                                <ul class="nav-menu">
                                    <asp:Literal ID="HTML_Link_GestionarObrasExistentes" runat="server"></asp:Literal>
                                    <asp:Literal ID="HTML_Link_NuevaObra" runat="server"></asp:Literal>
                                    <asp:Literal ID="HTML_Link_EliminarObra" runat="server"></asp:Literal>
                                </ul>
                            </div>
                            <div id="central-content" ><center><img src="images/inicio.JPG" /></center></div>
