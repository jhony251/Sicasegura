<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestionaobra.aspx.cs" Inherits="Obras_home_gestionaobra" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>Gestion de Obras CHS</title>
                ...
                <asp:Literal ID="HTML_Menu_Navegacion"   runat="server"></asp:Literal>
                    <div id="content-wrapper">
                        <p class="breath">
                            <a name="up" id="up"></a>
                                Estas en::
                            <a href="gestionaobra.aspx">GESTIONAR OBRA</a> 
                        </p>
                        <div id="left-column">
                            <ul class="nav-menu">
                        ...
                        <div id="central-content" ><center><a href="InfGnrlObra.aspx"><img src="images/buscarobra.JPG" /></a></center></div>
