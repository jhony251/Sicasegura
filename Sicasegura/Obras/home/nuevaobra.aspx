<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nuevaobra.aspx.cs" Inherits="Obras_home_nuevaobra" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>Nueva Obra de CHS</title>
                ...
                <asp:Literal ID="HTML_Menu_Navegacion"   runat="server"></asp:Literal>
                    <div id="content-wrapper">
                        <p class="breath">
                            <a name="up" id="up"></a>
                                Estas en::
                            <a href="nuevaobra.aspx">NUEVA OBRA</a> 
                        </p>
                        <div id="left-column">
                            <ul class="nav-menu">
                        ...
                        <div id="central-content" ><center><img src="images/crearobra.JPG" /></center></div>
