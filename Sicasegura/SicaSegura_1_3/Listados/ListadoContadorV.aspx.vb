...
Partial Class Listados_ListadoContadorV
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            ",[Aforable],[DistanciaPtoAforo_Km],v_numeroserie, v_marca, v_ffcontvolum " & _
            ",p.denominacionPunto,c.descripcion " & _
            ",[CodigoCaracterizacion] FROM PVYCR_Contadores C, PVYCR_puntos P " & _
            ...
            reportgenerator1.LoadTemplate(Server.MapPath("ListadoContadorV.rst"))
