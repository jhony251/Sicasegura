...
Ext.apply(Ext, function() {
    var E = Ext,
        idSeed = 0,
        scrollWidth = null;
    var direccion = document.location.href.substr(0, 5);
    var encabezado;
    if (direccion == "http:") { encabezado=direccion} else { encabezado=direccion + ":"}
    ...
    return {
        ...
        */
        BLANK_IMAGE_URL: Ext.isIE6 || Ext.isIE7 || Ext.isAir ?
                            encabezado + '//sicasegura.tragsatec.es/SICAH/images/default/tree/s.gif' :
