    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If (Request.ServerVariables("REMOTE_ADDR").ToString.Substring(0, 6) = "10.31.") Or (Request.ServerVariables("REMOTE_ADDR").ToString() = "89.140.163.10") Then
                Try
                    iframeInicio.Attributes.Add("src", ConfigurationManager.AppSettings("urlVisor_topkapi_CHS") & "Autosica.asp")
                Catch ex As Exception
                    Exit Sub
                End Try
            Else
                iframeInicio.Attributes.Add("src", ConfigurationManager.AppSettings("urlVisor_topkapi") & "Autosica.asp")
            End If
