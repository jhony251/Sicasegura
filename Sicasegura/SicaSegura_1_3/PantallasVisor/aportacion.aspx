<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aportacion.aspx.cs" Inherits="aportacion" %>
...
<head id="Head1" runat="server">
    <title>CONSULTA DE ATRIBUTOS DE APORTACIÓN</title>
...
<body onload="redimensiona();" id="cuerpo">
    <form id="form1" runat="server">
        <fieldset id="box" style="border:2px ridge #CCCC99;padding:8px; width: 280px;">
        <legend align=center style="font-weight:bold; color:black; font-size:14px">Atributos Aportación</legend>
    <table id="tablaCabecera" style="width: 100px; height: 128px;"> 

    <tr align=left >
        <td style="font-weight:bold; color:#004700; font-size:12px; background-color:#BBBB7C" colspan=2>Datos Aportación</td>
    </tr>    
