...
Partial Class SICAH_CurvasAcequiasDETALLEData2
    ...
    Sub CrearDataSetCurvaAcequia()
        ...
        ActualizarDataSetValoresCurva(dstCurvasAcequias.Tables("TablaCurvasAcequias").Rows(0).Item("Cod_curva").ToString)
       
        MiGrafico.AddElement(CreacionLineas(dstCurvasAcequias.Tables("TablaCurvasAcequiasValores"), 0, dstCurvasAcequias.Tables("TablaValoresTodasLasCurvas"), arrayColores(j), paso))
