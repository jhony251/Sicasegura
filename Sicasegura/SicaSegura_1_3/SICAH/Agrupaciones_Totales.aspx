        ...
        <td>
           <!-- Panel Puntos Agrupacion-->
                ...
                <br><asp:Label ID=lblTitulo runat=server CssClass=tituloSec ForeColor=Maroon><B>TOTALES AGRUPACIÓN</B></asp:Label><br/>
                    <table cellspacing=2 align="left" width= "500" cellpadding=1 style="border:1px solid Maroon;background-color:WhiteSmoke" >
                    <tr>
             ...
             <tr>
                    ...
                    <td><asp:Button ID="btnActualizar" runat="server" Text="Actualizar" CssClass="boton"/></td>    </tr>
                    <tr>
                    <td>Volumen General(m3)
