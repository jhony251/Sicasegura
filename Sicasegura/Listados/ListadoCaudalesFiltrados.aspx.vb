...
#End Region
            ...
            If Request.QueryString("format") Is Nothing Then
                If Request.QueryString("grafico") = "si" Then
                    ...
                    If dst.Tables("listado").Rows.Count > 0 Then
                        ...
                        If (idElementoMedida.Contains("H")) Then
                            Response.Redirect("../SICAH/controlcauces/graficolecturas.aspx")
                        End If
    ...
    Private Sub CalcularVariablesGlobales()
        ...
        dst.Tables("listadoGlobales").Rows(0).Item("Nodo") = Session("nodoTexto")
