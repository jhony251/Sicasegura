...
<iframe name="frameUtil" id="frameUtil" src="" style="display:none"></iframe>
  ...
  <span id="imagepath" style="display:none">../js/calendar/images</span>
    <table cellspacing="0" align="center" width="100%" style="border: 1px solid #666666;
      background-color: white" height="100%">
      <tr>
        <td style="width: 100%" height="100%" >
          <table cellspacing="0" cellpadding="0" width="100%" height="100%">
            <!--<asp:Label ID="lblCabecera" runat="server"></asp:Label><asp:Label ID="lblPestanyas" runat="server"></asp:Label>  -->
            <tr><td height="0px" valign=middle>
            <asp:Label ID="lblpresentacion" runat="server" Height="0px"></asp:Label>
           </td></tr>
            ...
            <tr>          
              <td>
                 <table>
                     <tr>
                       <asp:Label ID="lblPestanyasArbolQ" runat="server"></asp:Label>
            ...
            <!--<tr>
              <td style="width: 915px">
                ...
                <tr>
                    ...
                    <td style="padding-left:5px; width: 100%;border:1px solid #666666" valign=top >
                        ...
                        <table width="99%" id="TablaFiltrosE" bgcolor="#FEFCC1">
                            ...
                            <table id="TABLE3" width="99%">                              
                                    ...
                                    <td class="encabListado" style="width:11px">En Marcha</td>
                            ...
                            <table width="99%" bgcolor="#BFBDC0">
                                <tr>
                                    ...
                                    <td align="left" width="250px">
                                        <asp:Image runat="server" ImageUrl="~/SICAH/images/iconos/Grafica2.gif" ID="imgGraficoLecturas" Style="cursor: pointer" Visible="false" />
                                        <asp:LinkButton ID="btnGraficoLecturas" runat="server" Text="Gráfico de lecturas" CssClass="enlaceLecturas" Visible="false" /> 
                                    </td> 
                                    <td align="left" >
                                ...
                                <tr>
                                    ...
                                    <td align="left" >
                                        ...
                                        <asp:LinkButton ID="btnGrafico" runat="server" Text="Gráfico de consumos y lecturas" CssClass="enlaceLecturas" /> 
                                    </td> 
                                    <td align="left" >
                        ...
                        <!-- Panel Volumen -->    
                        <asp:Panel ID=pnlVolumen Runat=server Visible=false style="overflow:auto; width:100%;" >          
                            ...
                            <table width="99%" bgcolor="#BFBDC0" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:LinkButton ID="btnGraficoV"  runat="server" Text="Gráfico de consumos y lecturas" CssClass="enlaceLecturas"  />                                      
                                    </td>
                                    <td nowrap>
                        ...
                        <table width="99%" id="Table5" bgcolor="#FEFCC1" >
                            ...
                            <table id="TABLE2" width="99%">
                                    ...
                                    <td class="encabListado">En Marcha</td>
                        ...
                        <asp:Panel ID=pnlHorometros Runat=server Visible=false  style="overflow:auto;height: 692px; width:100%;">
                           <table width="99%">
                            ...
                            <tr>
                                ...
                                <td>
                                        <asp:Image runat="server" ImageUrl="~/SICAH/images/iconos/Grafica2.gif" ID="Image6" Style="cursor: pointer" />
                                        <asp:LinkButton ID="btnGraficoH"  runat="server" Text="Gráfico de consumos y lecturas" CssClass="enlaceLecturas"  />                                      
                                </td>
                            </tr>
                              <tr>
                        ...
                        <table width="99%" id="Table6" bgcolor="#FEFCC1" >
                            ...
                            <table width="99%">                                               
                                 <tr>
                                    ...
                                    <td class="encabListado" style="width:40px">En Marcha</td>
