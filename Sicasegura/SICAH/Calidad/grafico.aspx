...
<body style="width:100%; font-family:Verdana; margin:0px;">
    ...
    <table style="width:100%; font-size:8pt; font-weight:bold; color:White;" cellpadding="0" cellspacing="0">
        <tr class="header-default">
            <td style="width:20%;text-align:center;">
                <asp:Literal ID="LIT_LinkConduct" runat="server"></asp:Literal>Conductividad (uS/cm)</td> 
            <td style="width:20%;text-align:center;">
                <asp:Literal ID="LIT_LinkTurb" runat="server"></asp:Literal>Turbidez (ppm)</td>
            <td style="width:20%;text-align:center;">
                <asp:Literal ID="LIT_LinkLDO" runat="server"></asp:Literal>LDO (mg/l)</td>
            <td style="width:20%;text-align:center;">
				<asp:Literal ID="LIT_LinkPH" runat="server"></asp:Literal>PH</td>
            <td style="width:20%;text-align:center;">
                <asp:Literal ID="LIT_LinkTemp" runat="server"></asp:Literal>Temperatura (ºC)</td>
        </tr>
        <tr>
            <td colspan="5">
                <div id="chart2" style="width: 100%; margin-left: 0px; height: 267px;"></div>
    ...
    <script type="text/javascript">
        jQuery(function() { 
                            var chart2 = new Highcharts.StockChart({
                                ...
                                navigator: { height: 60 },
                                title: { text: 'Valores', floating: true, align: 'center', x: -20, top: 20 },
