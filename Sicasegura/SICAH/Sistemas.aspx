...
<title>SICA - Sistema Integrado de Control de Aprovechamientos</title>
      ...
      <script type="text/javascript" language="javascript" src="../js/utilesObjetoArbolSistemas.js"></script> 
                                    ...
                                    <tr>
                                        <td style="padding-left:20px; padding-right:20px; width:79%" valign=top>
                                            ...
                                            <asp:Panel ID=pnlCauces Runat=server Visible=true>
                                                ...
                                                <table width=100%>  
                                                    <tr><td class="tituloSec" colspan=2>MANTENIMIENTO DE SISTEMA DE CONTROL DE VOLÚMENES</td></tr>
                                                    <tr>
                                                        <td  align="left" colspan="2"><a id = "MostrarFiltro" href="javascript:void(0)" onclick="javascript:filtrar()">Ocultar Filtro</a></td>
                                                        <td align="right" width="90"><asp:LinkButton Visible=<%#VisibleSegunPerfil() %> runat="server" ID="lbtNuevo" OnClick="nuevoCauce">&nbsp;Nuevo</asp:LinkButton></td>
                                                    </tr>
                                                    <tr>                                                        
                                                    ...
                                                    <asp:Repeater ID=rptCauces runat=server>                                                     
                                                        <ItemTemplate>
                                                        <tr <%# checkFila()%>>                                            
                                                            <td><%#Container.DataItem("NumInscripcion")%> -- <%#Container.DataItem("Descripcion")%> </td>
                                                            ...
                                                            <td align="right">
                                                                ...
                                                                <asp:LinkButton ID=lbtAportaciones Visible=<%# VisibleSegunPerfil() %> Runat=server CommandName='Aportaciones' CommandArgument='<%#"" & container.dataitem("id") %>'><img src="agrupaciones/images/aportaciones.png" height="20" border=0 alt="Borrar"></asp:LinkButton>
                            	                            </td>
            	                                        </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                            ...
                                            <asp:Panel ID="pnlEDCauces" runat=server Visible=false>                      
                                                ...
                                                <table width="100%" cellspacing=0 cellpadding=1 class="tablaEdicion" border="0" >
                                                    <tr>
                                                        <td style="width: 120px;" valign="top">SCV del RAACS:</td>                                                        
                                                        <td><asp:RadioButtonList runat="server" ID="rbEsRAAC" AutoPostBack="true" 
                                                                OnSelectedIndexChanged="FireOnSelectedIndexChangd" RepeatDirection="Horizontal">
                                                    ...
                                                    <asp:Panel ID="pnlIDRaac" Visible="false" runat="server">
                                                        ...
                                                        <tr>
                                                            <td>Modificar concesión (m3)</td>
                                                            <td>
                                                                <asp:TextBox ID="txtModifConcesion" runat="server" CssClass="texto"></asp:TextBox>                                                                
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="txtModifConcesion" runat="server" ValidationExpression="^[+-]?([0-9]*\,?[0-9]+|[0-9]+\,?[0-9]*)([eE][+-]?[0-9]+)?$" ErrorMessage="La modificación de la concesión debe ser un númeno positivo o negativo"></asp:RegularExpressionValidator>
                                                            </td>
                                                        </tr>
                                                    </asp:Panel>   
