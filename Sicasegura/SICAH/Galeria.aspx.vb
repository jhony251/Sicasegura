...
Partial Class SICAH_galeria
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Response.Redirect("./galeria/galeria.aspx?clavenodo=" & Request.QueryString("clavenodo"))
  ...
  Public Sub CargarFotos(ByVal CodigoPunto As String)
    ...
    strHtml &= "<td align='center' valign='bottom' colspan='5' style='text-align:center;'>"
        ...
        strHtml &= "<center><a href='../../BaseFotografica/Images/01-Croquis/" & Request.QueryString("clavenodo") & ".jpg' rel='lightbox_plus' class='vertical' target='_blank'>"

        strHtml &= "<img width='320' height='226' src='../../BaseFotografica/Images/01-Croquis/TB/" & Request.QueryString("clavenodo") & ".jpg'  onerror=" & comillas & "this.src='" & miniaturaError & "';" & comillas & "> "
    ...
    While (Contador <= NumeroImagenes)
            cadena = "../../BaseFotografica/Images/" & Request.QueryString("clavenodo") & "/" & Request.QueryString("clavenodo") & "-" & String.Format("{0:000}", Contador) & ".JPG"
            miniatura = "../../BaseFotografica/Images/" & Request.QueryString("clavenodo") & "/TB/" & Request.QueryString("clavenodo") & "-" & String.Format("{0:000}", Contador) & ".JPG"
