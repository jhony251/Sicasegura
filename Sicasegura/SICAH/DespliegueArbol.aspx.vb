...
Partial Class SICAH_DespliegueArbol
            ...
            Select Case tipo
                ...
                Case "E"
                    ...
                    Select Case tipoElemen
                        Case "C"
                            hijos &= "href:'Calidad2.aspx?PVYCR=" & codigoPVYCR & "&nodotexto=" & descripcion & "&nodoclave=" & nodoclave & "&x=" & nivel & "',hrefTarget:'blank'," & _
                            "id:'" & codigoPVYCR & "-" & idElementoMedida & "',text:'" & descripcion & "',leaf:'true'"
                        Case Else
                            hijos &= "href:'InformacionGeneral.aspx?nodotexto=" & descripcion & "&nodoclave=" & nodoclave & "&x=" & nivel & "',hrefTarget:'iframeDetalle'," & _
                            "id:'" & codigoPVYCR & "-" & idElementoMedida & "',text:'" & descripcion & "',leaf:'true'" ',cls:'ElementoMedidaTree'"
                    End Select
                    
                    'ipim 21/03/2012                    tipoElemen = idElementoMedida.Substring(0, 1)
                    Select Case tipoPunto
                        Case "G"
                            Select Case tipoElemen
                                Case "Q"
    ...
    Private Function RamasVisiblesString()
        ...
        If (dstRamasVisibles.Tables("tablaVisibles").Rows.Count = 0) Then
            ...
            str = str & ",{id: 'AZ',text: 'AZ Azarbes',cls:'CauceNivel0Tree'}"
            ...
            str = str & ",{id: 'DS',text: 'DS Desaladoras',cls:'CauceNivel0Tree',visible: false }"
