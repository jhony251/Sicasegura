<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sistemas_old.aspx.vb" Inherits="SICAH_sistemas_old" %>
                    ...
                    <td style="padding-left:20px; padding-right:20px; width: 79%;" valign=top>
                        ...
                        <asp:Panel ID="pnlSistemas" Runat=server>
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td>
                                    <asp:TextBox ID="txtFiltroNombreSistema" runat="server" Text="[Nombre Sistema]" CssClass="texto"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="2" style="color:#555555"><i></i></td>
                                </tr>
                                </table>
                                </td>
                            </tr>
                            ...
                            <table width="100%">  
                                <tr>
                                    <td colspan="2" style="height: 17px" class="tituloSec">
                                        MANTENIMIENTO DE SISTEMAS</td>
                                    <td align="left" style="width: 121px; height: 17px">
                                    </td>
                                </tr>
                                <tr><td style="width: 92px; height: 258px;"> 
                                ...
                                <asp:Panel ID="pnlArbol" runat="server" ScrollBars="Both" BorderStyle="Solid" BorderWidth="1px" Height="300px" Width="500px" HorizontalAlign="Left">
                                    ...
                                    <td align="left" style="width: 193px; height: 258px;" valign="top">
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td style="width: 5px; height: 5px;"><asp:ImageButton Visible=<%#VisibleSegunPerfil() %> ID="imgNuevoRaiz" runat="server" ImageUrl="~/SICAH/images/SubSistemas.gif" /></td>
                                                <td colspan="2">
                                                    Nuevo Sistema Raiz</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 5px; height: 5px;">
                                                    <asp:ImageButton ID="imgNuevo" Visible=<%#VisibleSegunPerfil() %> runat="server" ImageUrl="~/SICAH/images/SubSistemas2.gif" /></td>
                                                <td colspan="2">
                                                    Nuevo Subsistema</td>
                                            </tr>
                                            <tr>
                                                <td style="height: 5px; width: 5px;">
                                                <asp:ImageButton ID="imgEditar" Visible=<%#VisibleSegunPerfil() %> runat="server" ImageAlign="absmiddle" ImageUrl="../images/edit.gif" ToolTip="Ediar Nodo" Height="15px" Width="12px" /></td>
                                        ...
                                        Editar</td>
                                            ...
                                            <tr>
                                                ...
                                                <asp:ImageButton ID="imgBorrar" runat="server" ImageAlign="absmiddle" 
                                                    ImageUrl="../images/del.gif" Width="16px" Visible=<%#VisibleSegunPerfil() %> ToolTip="Borrar Nodo" CausesValidation="False" /></td>
                        ...
                        <br /><asp:Label ID=lblTitulo runat=server CssClass=tituloSec><B>SISTEMA: </B></asp:Label><br /><br />
                            ...
                            <td>
                                ...
                                <tr>
                                    ...
                                    <td><asp:TextBox ID=txtNombre runat=server CssClass=texto Width="296px"></asp:TextBox><br />
                                    <asp:RequiredFieldValidator ID=RequiredFieldValidator4 runat=server Display=Dynamic ErrorMessage="El nombre del sistema es obligado" ControlToValidate=txtNombre></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" colspan="2" style="border-top:1px solid #666666">
