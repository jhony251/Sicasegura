...
Partial Class SICAH_SeguimientoAdministrativo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            lblPestanyas.Text = genHTML.pestanyasMenuDentroSICAH(6, "../", Page, Session("idperfil"), Session("usuarioReg"))
            crearDataSets()
            rellenarListas()
    ...
    Protected Sub rptSeguimientosAdministrativos_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.RepeaterCommandEventArgs) Handles rptSeguimientosAdministrativos.ItemCommand
        ...
        Select Case e.CommandName
            Case "AddFiles"
                ...
                Dim csname1 = "ventana_ficheros"
                Dim cstype As Type
                cstype = Me.GetType()
                cs = Page.ClientScript
                If Not (cs.IsStartupScriptRegistered(cstype, csname1)) Then
                    Dim cstext1 As String = "ventanaCargaFicheros('" & parametros(0) & "444" & parametros(1) & "444" & parametros(2).Replace(" ", "").Replace(":", "") & "');"
    ...
    End Function
    Protected Function hayficheros(ByVal param As String) As String
        If (System.IO.Directory.Exists("c:\uploads\" & param.Replace("/", "").Replace(" ", "").Replace(":", ""))) Then
            If (System.IO.Directory.GetFiles("c:\uploads\" & param.Replace("/", "").Replace(" ", "").Replace(":", "")).Length > 0) Then
                hayficheros = "files"
            Else
                hayficheros = ""
            End If
