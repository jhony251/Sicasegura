...
<body style="background-color:White; height:100%;">
    ...
    <table cellspacing="2" align="center" style="width:100%; height:100%; border: 0px solid #666666;background-color: white;">
        <tr>
            <td style="padding-left:20px; padding-right:20px; width:100%" valign="top">
                <!-- Panel listar Regimenes de Curva asociados al elemento de medida -->
                    <asp:Panel ID="pnlCurvasAcequias" runat="server" Visible="false">
                        <table width="100%">
                            <tr>
                                <td class="tituloSec" colspan="10">
                                    <asp:Label ID="Label1" runat="server" CssClass="tituloSec" Height="1px" Width="473px"><b> MANTENIMIENTO CURVAS DE ACEQUIAS </b></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="10" align="right">
                                    <asp:LinkButton Visible=<%#VisibleSegunPerfil() %> runat="server" ID="lbtNuevo" OnClick="nuevaCurvaAcequia">
                                        Nueva Curva
                                    </asp:LinkButton>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td width="40%" valign="top"><br /><asp:Label ID="lblInformeCurvasAcequias" runat="server"></asp:Label>
                                            </td>
                                        <tr>
                                            <td>
                                                <%--<div id="ChartSeriesDeCurvasAcequiaN">--%>
                                                <div ID="chart2" style="width: 100%; margin-left: 0px; height: 400px;">
                                                </div>
                                                <%--<script type="text/javascript">
                ...
                <!-- Fin Panel listar  Curvas de Acequiass -->
                    <asp:Label ID="LBLinfoclave" runat="server" Visible="False" Width="0px">
                    </asp:Label>
                    <asp:Label ID="LBLinfo" runat="server" Visible="False" Width="0px">
                    </asp:Label>&nbsp;
                <!-- Panel Editar  Curvas de Acequias-->                        
                    <asp:Panel ID="pnlEDCurvasAcequias"  Runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="0px">
                        ...
                        <br />
                        <asp:Label ID="lblTitulo" runat="server" CssClass="tituloSec" Height="1px" Width="473px">
                            <b> MANTENIMIENTO CURVA DE ACEQUIA: </b>
                        </asp:Label>
                        <table id="Table2" border="0" cellpadding="2" cellspacing="2">
                            ...
                            <tr style="color: #000000">
                                ...
                                <td style="width: 40px; text-align: left">
                                    <asp:Label ID="lblDescripcionAcequia" runat="server" Width="302px" CssClass="texto" BorderWidth="0px">
                                    </asp:Label>
                                </td>
                            </tr>
                            <tr style="color: #000000">
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="width: 87px; height: 21px;">
                                                <asp:TextBox ID="txtFechaInicioUso" runat="server" CssClass="texto" Height="13px" Width="87px">
                                                    </asp:TextBox>
                                            </td>
                                            <td style="width: 20px; height: 21px">
                                                <asp:Image ID="imgFechaInicioUso" runat="server" align="absmiddle" ImageAlign="Left" ImageUrl="~/images/calendario.gif" Style="cursor: pointer" />
                                            </td>
                                            <td style="width: 43px; height: 21px">
                                                &nbsp;
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Se requiere valor" Width="176px" ControlToValidate="txtFechaInicioUso">
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="width: 94px; height: 21px;">
                                                <asp:TextBox ID="txtFechaFinUso" runat="server" CssClass="texto" Height="13px" Width="87px"></asp:TextBox>
                                            </td>
                                            <td style="width: 27px; height: 21px">
                                                <asp:Image ID="imgFechaFinUso" runat="server" align="absmiddle" ImageAlign="Left" ImageUrl="~/images/calendario.gif" Style="cursor: pointer" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 40px; height: 24px; text-align: left">
                                    &nbsp;
                                    <asp:CheckBox ID="chkenActivo" runat="server" CssClass="texto" Style="left: -6px; position: relative; top: 0px" Width="96px" />
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td rowspan="4" style="width: 515px" valign="top">
                                                    <div id="chart21" style="width: 100%; margin-left: 0px; height: 267px;"></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="height: 184px; width: 150px;" valign="top">
                                                    <asp:Panel ID="pnlCurvasAcequiasValores" runat="server" Height="220px" Width="172px" HorizontalAlign="Left" ScrollBars="Vertical">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" style="width: 173px">
                                                            <tr>
                                                                <td class="encabListado" style="width: 12px">
                                                                    <asp:TextBox ID="txtNuevoNivel" runat="server" CssClass="texto" Width="35px"></asp:TextBox>
                                                                </td>
                                                                <td class="encabListado" style="width: 8px">
                                                                    <asp:TextBox ID="txtNuevoCaudal" runat="server" CssClass="texto" Width="35px"></asp:TextBox>
                                                                </td>
                            ...
                            <tr>
                                <td align="right" colspan="7" style="border-top: #666666 1px solid; height: 24px">
                                    ...
                                    <asp:Button ID="btnCancelar" runat="server" CausesValidation="False" CssClass="boton" Text="Cancelar" />
                                </td>
                            </tr>
                        </table>
                   </asp:Panel>  
    ...
    <asp:Literal ID="LIT_graficoedicion" runat="server" ></asp:Literal>
