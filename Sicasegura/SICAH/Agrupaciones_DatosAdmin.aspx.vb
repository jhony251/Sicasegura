...
Partial Class SICAH_Agrupaciones_DatosAdmin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            Dim carpeta As String = "ruta_ficheros_aprovechamientos"
            LBL_DescargaHoja.Text = "<a href='agrupaciones/download.aspx?carpeta=" & carpeta & "&file=" & file & "' target='_blanck'><font color='#ffffff'>Hoja de aprovechamiento <img border='0' src='agrupaciones/images/pdf.png' height='18'></font></a>"
        ...
        If Not IsPostBack Then
            ...
            'lblTitulo.Text = "<b>REGISTRO DE AGUAS : Datos administrativos del aprovechmamiento ID " & UCase(Request.QueryString("Nombre")) & ".</b>"

            'If Request.QueryString("RAAC") = "1" Then
            'Se cargan los datos del Registro de la Agrupación
            If Request.QueryString("RAAC") <> "0" Then
    ...
    Protected Sub CargarDatosAgrupacion(ByVal NumInscripcion As String)
        ...
        If NumInscripcion <> "" Then
            ...
            If dstRegistro.Tables("TablaRegistro").Rows.Count > 0 Then
                ...
                Me.txtCESP.Text = utiles.nullABlanco(dstRegistro.Tables("TablaRegistro").Rows(0).Item("CESP"))
                dstRegistro.Dispose()
            End If
        End If
