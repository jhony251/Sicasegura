<%@ Page Language="C#" AutoEventWireup="true" CodeFile="obras.aspx.cs" Inherits="SICA_obras" %>
                ...
                <div id="container2">
                    ...
                    <div id="content-wrapper">
                        <p class="breath">
                            <a name="up" id="up"></a>
                                Estas en::
                            <a href="index.aspx">SICA</a> > <a href="Obras.aspx">Obras</a>
                        </p>
                        ...
                        <div id="central-content"  style="width:99%">
                            <div class="table">
                                <asp:Literal ID="HTML_Tabla_listado_ISM"   runat="server"></asp:Literal>
                            </div>
                        </div>
                   </div>    
