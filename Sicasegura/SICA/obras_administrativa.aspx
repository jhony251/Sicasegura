<%@ Page Language="C#" AutoEventWireup="true" CodeFile="obras_administrativa.aspx.cs" Inherits="SICA_obras_administrativa" %>
        ...
        <form id="form1" runat="server">
            <div id="container">
                <div id="container2">
                    ...
                    <div id="left-column">
                        <ul class="nav-menu">
                                <li><a href="obras_general.aspx">Documentacion General</a></li>
                                <li class="selected"><a href="obras_administrativa.aspx">Documentacion Administrativa</a></li>
