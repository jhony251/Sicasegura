    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                ClientScript.RegisterStartupScript(Page.GetType, "Cargar", "<script>document.getElementById('iframeTotales').src='Agrupaciones_Totales.aspx?Nombre=" & nombreAgrupacion & "';</script>")

                ClientScript.RegisterStartupScript(Page.GetType, "Cargar2", "<script>document.getElementById('iframeAdmin').src='Agrupaciones_DatosAdmin.aspx?Nombre=" & nombreAgrupacion & "';</script>")
                ...
                lblTitulo.Text = "CONTENIDO AGRUPACION " & UCase(Request.QueryString("Nombre"))
