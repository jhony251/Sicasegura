     ...
     <form id="form1" runat="server" >
        ...
        <td>
           <!-- Panel Puntos Agrupacion-->
                ...
                <br><asp:Label ID=lblTitulo runat=server CssClass=tituloSec><B>DATOS ADMINISTRATIVOS AGRUPACIÓN</B></asp:Label><br/>
                    <table width=100% cellspacing=0 cellpadding=0 class="tablaEdicion" style="background-color:#eeead2"  >
                    <tr>
                    <td>
                    <tr  ><asp:Label ID="lblPestanyas" runat="server"></asp:Label></tr>
                                        ...
                                        <table cellpadding="2" cellspacing="2"  >
                                            ...
                                            <tr>
                                                <td>
                                                    Regadío</td>
                                                <td>
                                                    <asp:CheckBox ID="chkUSORE" runat="server" ReadOnly=true></asp:CheckBox>
                                                </td>
                                                <td>
                                                    Volumen Regadío</td>
                                                 <td>
                                                ...
                                                <td>
                                                    Industrial</td>
                                                <td>
                                                    <asp:CheckBox ID="chkUSOIN" runat="server" ReadOnly=true></asp:CheckBox>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    Abastecimiento</td>
                                                <td>
                                                    <asp:CheckBox ID="chkUSOAB" runat="server"  ReadOnly=true></asp:CheckBox>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    Ganadero</td>
                                                <td>
                                                    <asp:CheckBox ID="chkUSOGA" runat="server" ReadOnly=true></asp:CheckBox>
                                                </td>
                                                <td>
                                                    Volumen Ganadero</td>
                                                 <td>
