...
Partial Class SICAH_Agrupaciones_Totales
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        ...
        If Not IsPostBack Then
            ...
            If Not Request.QueryString("Nombre") Is Nothing Then
                ...
                '   
                lblTitulo.Text = "TOTALES AGRUPACIÓN " & UCase(Request.QueryString("Nombre"))
    ...
    Protected Sub CalculoTotales()
        ...
        sentencia = "SELECT     [SICA_SIST_Sistemas-Punto].ID_Sistema, SICA_SIST_PuntoSistema.CodigoPVYCR, SICA_SIST_PuntoSistema.EM " & _
                 ...
                 " WHERE SICA_SIST_Sistemas.Descripcion='" & Request.QueryString("Nombre") & "'"
        ...
        txtVolumenGeneral.Text = volumenGeneral
        txtConcesionAprov.Text = concesionAprovechamiento
        txtPorcentajeTotal.Text = PorcentajeTotal
