...
Namespace GuarderiaFluvial
    ...
    Public Class genHTML
        ...
        Shared Function ObtenerPresentacion() As String
            ...
            presentacion = "<table width=""100%"" height=""600"" border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"" style=""background-image: url(images/fondoPresentacion.jpg);" & _
        ...
        Shared Function pestanyasMenu(ByVal seccion As Integer, ByVal subsec As String, ByVal pagina As Page, ByVal idperfil As Integer, ByVal idUsuario As Integer) As String
            ...
            Dim estiloPest1 As String = "glink", estiloPest2 As String = "glink", estiloPest3 As String = "glink", estiloPest4 As String = "glink", estiloPest5 As String = "glink"
            ...
            resul &= "<li class=""nivelPequenyo""><a href=""javascript:void(0)""  class='" & estiloPest5 & "'>AGRUPACIONES</a>" & _
                     "<ul>" & _
                     "<li><a href='" & subsec & "SICAH/Sistemas.aspx?pag=5'>ALTA</a></li>" & _
                     "<li><a href='" & subsec & "SICAH/Agrupaciones_new.aspx?pag=5'>MANTENIMIENTO</a></li>" & _
                     "</ul>" & _
                     "</li>"
