<%@ Page Language="VB" AutoEventWireup="false" CodeFile="infoElemento.aspx.vb" Inherits="PantallasVisor_infoElemento" %>
...
<body onload="redimensiona();"  id="cuerpo">
    <form id="form1" runat="server">
        <fieldset id="box" style="border:2px ridge #CCCC99;padding:8px; width: 872px;">
        <legend align=center style="font-weight:bold; color:black; font-size:14px">Elemento
            de Medida</legend>
